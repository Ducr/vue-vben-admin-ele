...
function pwa(): PwaOptions {
  return {
    ...
    manifest: {
      description:
        'Vben Admin Ele is an Element Plus version SPA independently split from Vue Vben Admin v5.5.9. A modern admin dashboard template based on Vue 3.',
      icons: [
        {
          sizes: '192x192',
      ...
      id: '/',
      name: 'Vben Admin Ele Doc',
      short_name: 'vben_admin_ele_doc',
      theme_color: '#ffffff',
    },
