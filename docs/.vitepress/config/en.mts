...
export const en = defineConfig({
  description: 'Vben Admin Ele - Element Plus version SPA independently split from Vue Vben Admin v5.5.9',
  lang: 'en-US',
  themeConfig: {
  ...
  return [
          ...
          items: [
            {
              ...
              text: 'Element Plus Version (Current)',
            },
            {
    ...
    },
    {
      ...
      items: [
        ...
        {
          link: 'https://github.com/Ducr/vue-vben-admin-ele',
