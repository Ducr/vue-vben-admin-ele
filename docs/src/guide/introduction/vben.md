...
::: info 你正在阅读的是 [Vben Admin Ele](https://github.com/Ducr/vue-vben-admin-ele) `5.5.9`版本的文档！这是基于 Vue Vben Admin v5.5.9 独立拆分的 Element Plus 版本单页应用（SPA）。
